...
const ModelDemo = ({ chatHistory, setChatHistory }: ModelDemoProps) => {
  ...
  return (
    <div className="flex h-full">
      ...
      {/* Main Content */}
      <div className="flex-1 max-w-4xl mx-auto p-6 space-y-6 flex flex-col items-center overflow-y-auto">
